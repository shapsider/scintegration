...
def get_metacells(
    ...
    *adatas
    ...
    # combined.write("/data0/tzc/SingleCell/CoVEL3/figure/kmeans/combined.h5ad")
    # K-means
    # clust_method = sklearn.cluster.KMeans(n_clusters=n_meta, random_state=seed)
    
    # DBSCAN
    # DBSCAN处理不了高维度数据(50-dim都失效了)
